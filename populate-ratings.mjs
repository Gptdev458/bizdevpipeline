// Node.js script to run the populate ratings function
import { createClient } from '@supabase/supabase-js';

// Supabase configuration (same as in your app)
const SUPABASE_URL = 'https://lqnpzkbwpyfyibhbfhao.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxxbnB6a2J3cHlmeWliaGJmaGFvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzUxNzE3MjcsImV4cCI6MjA1MDc0NzcyN30.4CsQqNqVMF7OG6Q8FGMULs7-mj6T4xP9i4OkKW4dkVo';
...
async function getProjects() {
  try {
    ...
    return projects.map(project => ({
      ...
      isIanCollaboration: project.is_ian_collaboration,
      detailedRatingsData: project.detailed_ratings_data || {}
    }));
  } catch (error) {
...
async function updateProject(projectId, updates) {
  try {
    ...
    if (updates.detailedRatingsData !== undefined) {
      dbUpdates.detailed_ratings_data = updates.detailedRatingsData;
    }
  ...
  try {
    ...
    for (const ratingData of ratingsData) {
      try {
        ...
        await updateProject(match.project.id, {
